...
<html lang="en">
  <head>
    ...
    <title>Date Converter - Hijri to English</title>
...
<body class="text-center bg-dark">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm">
        <h3>From Hijri to English</h3>
      </div>
      <div class="col-sm">
        <form action="arabic.php" method="post">
          <div class="row">
            <div class="col">
      ...
      <div class="col-sm">
        <a href="english.php" class="btn btn-light">English to Hijri</a>
      </div>
    </div>
  </div>
...
if(isset($_POST['convert'])){
  ...
  $am = $_POST['month'];
  $ay = $_POST['year'];
    $F_RETURN    =    FF0_TD_AR_TO_EN($ay,$am,$ad);
    $ar_y    =    $F_RETURN[0];
    $ar_m    =    $F_RETURN[1];
    $ar_d    =    $F_RETURN[2];

    echo '<br> <i class="num">' . $ar_m . '</i><i class="num">' . $ar_d . '</i><i class="num">' . $ar_y . '</i>';
}
?>
