...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<?=$stdesc;?>">
    <meta name="author" content="Ahmed Alsaleh, Meedo51">
    <link rel="icon" href="<?=$sticon;?>">
...
<body class="text-center bg-dark">
  <div class="jumbotron jumbotron-fluid bg-dark">
    ...
    <a href="arabic.php" class="btn btn-info">Hijri to English</a>
    <a href="english.php" class="btn btn-warning">English to Hijri</a>
    <a href="age.php" class="btn btn-light">Age Calculator</a>
